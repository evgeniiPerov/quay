...
- [Azure DevOps](tutorials/azure-devops.md)
- [Bitbucket](tutorials/bitbucket.md)
...
- [Share a skill with a team](recipes/share-with-team.md)
- [CI install via `--from-toml`](recipes/ci-add-from-toml.md)
- [Multi-org profiles](recipes/multi-org-profiles.md)
- [Direct vs PR push](recipes/direct-vs-pr-push.md)
- [Force update over local edits](recipes/force-update-modified.md)
...
- [`SKILL.md`](reference/skill-md.md)
- [`registry.json`](reference/registry-json.md)
- [`push-log.json`](reference/push-log.md)
